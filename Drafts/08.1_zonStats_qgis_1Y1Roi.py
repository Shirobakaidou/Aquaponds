# This Script calculates zonal statistics of ONE year for ONE roi
...
file_r = glob(os.path.join(path_r, "*.tif"))
#print(file_r)
rlayer = iface.addRasterLayer(file_r[0], "wmsk_667", "gdal")
#r_667 = iface.addRasterLayer(file_r[0], "wmsk_667", "gdal")
...
zonStats_param = {
    ...
    'RASTER_BAND': 3,
    'STATS': [9],
    'COLUMN_PREFIX': str(pair.get(band_index_ts[3-1]))+'_'
}
